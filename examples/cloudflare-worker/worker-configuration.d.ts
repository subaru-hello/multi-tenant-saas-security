/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=examples/cloudflare-worker/wrangler.jsonc examples/cloudflare-worker/worker-configuration.d.ts` (hash: 3d3fdd145760295159fc1eac24135779)
